...
Fatigue = {
    normal = {
        ...
        { time = 420, event = { 'dmgTimerMul', -.05, 'dmgCycle', -.5, 'animDuration', 1 },  text = "THIS IS THE END.",          desc = "-5% Timer...   -0.5s DmgCycle   +100% Slowness   [Final]", duration = 2, final = true },
        { time = 422, event = { 'dmgTimerMul', -.05 },                                      text = "",                          desc = "...-5% Timer...", duration = 2},
        { time = 425, event = { 'dmgTimerMul', -.05 },                                      text = "",                          desc = "...-5% Timer...", duration = 2 },
        { time = 430, event = { 'dmgTimerMul', -.05 },                                      text = "",                          desc = "...-5% Timer", duration = 2 },
        { time = 480, event = { 'atkBufferCap', 6, 'animDuration', 1, 'maxQuestSize', 1 },  text = "FAREWELL.",                 desc = "+1 MaxQuestSize   +6 QuestBuffer...   +100% Slowness", color = 'lB', duration = 4 },
        { time = 485, event = { 'atkBufferCap', 6, 'animDuration', 3, 'extraQuestVar', 1 }, text = "",                          desc = "+1 QuestVariance   ...+6 QuestBuffer...   +300% Slowness", duration = 4 },
        { time = 490, event = { 'atkBufferCap', 6, 'animDuration', 5 },                     text = "",                          desc = "...+6 QuestBuffer   +500% Slowness", duration = 4 },
        { time = 510, event = { 'animDuration', 11 }, --[[26]]                              text = "",                          desc = "+1100% Slowness" },
        { time = 540, event = { 'animDuration', 16 }, --[[42]]                              text = "",                          desc = "+1600% Slowness" },
        { time = 570, event = { 'animDuration', 20 }, --[[62]]                              text = "",                          desc = "+2000% Slowness" },
        { time = 600, event = { 'animDuration', 64 }, --[[126]]                             text = "",                          desc = "+6400% Slowness" },
    ...
    rEX = {
        ...
        { time = 360, event = { 'dmgTimerMul', -.1, 'dmgHeal', -1, 'animDuration', 1 }, text = "PARANOIA CLOUDS YOUR JUDGEMENT_",   desc = "-10% Timer...   -1 Heal   +100% Slowness", duration = 2 },
        { time = 362, event = { 'dmgTimerMul', -.05 },                                  text = "",                                  desc = "...-5% Timer...", duration = 2 },
        { time = 365, event = { 'dmgTimerMul', -.05 },                                  text = "",                                  desc = "...-5% Timer", duration = 2  },
        { time = 390, event = { 'dmgCycle', -.5, 'dmgWrong', 1 },                       text = "THE REVOLUTION HAS BEGUN_",         desc = "-0.5s DmgCycle   +1 FaultDmg" },
        { time = 420, event = { 'dmgTimerMul', -.1, 'animDuration', 1 },                text = "THE END OF AN ERA.",                desc = "[Final]   -10% Timer...   -100% Slowness",         duration = 3, final = true },
        { time = 423, event = { 'dmgTimerMul', -.05 },                                  text = "",                                  desc = "...-5% Timer...", duration = 3 },
        { time = 426, event = { 'dmgTimerMul', -.05 },                                  text = "",                                  desc = "...-5% Timer...", duration = 3  },
        { time = 430, event = { 'dmgTimerMul', -.05 },                                  text = "",                                  desc = "...-5% Timer...", duration = 3  },
        { time = 435, event = { 'dmgTimerMul', -.03 },                                  text = "",                                  desc = "...-3% Timer...", duration = 3  },
        { time = 440, event = { 'dmgTimerMul', -.02 },                                  text = "",                                  desc = "...-2% Timer!", duration = 3  },
    ...
    rDP = {
        ...
        { time = 90,  event = { 'extraQuestBase', .2 },                          text = "",                                           desc = "+0.2 QuestCards" },
        { time = 100, event = { 'dmgHeal', 1 }, --[[ 3 ]]                        text = "THINGS ARE BACK TO HOW THEY USED TO BE_!",   desc = "+1 Heal",        duration = 10, color = 'lO' },
        { time = 120, event = { 'dmgHeal', -1, 'animDuration', .5 }, --[[ 2 ]]   text = "MINOR ISSUES BECOME LARGE CONFLICTS_",       desc = "-1 Heal   +50% Slowness",         duration = 10 },
        { time = 140, event = { 'dmgHeal', -1 }, --[[ 1 ]]                       text = "YOU BLAME THEM FOR YOUR OWN PROBLEMS_",      desc = "-1 Heal",        duration = 10 },
        { time = 160, event = { 'reviveDifficulty', 3 },                         text = "THEY WOULD RATHER SPEND TIME ALONE_",        desc = "+3 ReviveDifficulty",       duration = 10 },
        { time = 180, event = { 'extraQuestBase', .2 }},                         -- Merged with below
        { time = 180, event = { 'dmgHeal', 1.5, 'animDuration', 1 }, --[[ 2.5 ]] text = "YOU PROMISE TO CHANGE_",                     desc = "+1.5 Heal   +0.2 QuestCards   +100% Slowness",         duration = 10, color = 'lO' },
        { time = 200, event = { 'dmgTimerMul', -.2 },                            text = "PROMISES ARE BROKEN_",                       desc = "-20% Timer",   duration = 10 },
        { time = 220, event = { 'dmgHeal', -.5 }, --[[ 2 ]]                      text = "CONVERSATIONS DEVOLVE TO SHOUTING MATCHES_", desc = "-0.5 Heal",        duration = 10 },
        { time = 240, event = { 'extraQuestBase', .2, 'animDuration', 1 } },
        { time = 240, event = { 'dmgHeal', -.5 }, --[[ 1.5 ]]                    text = "ALL TRUST HAS WITHERED AWAY_",               desc = "-0.5 Heal   +0.2 QuestCards   +100% Slowness",         duration = 10 },
        { time = 260, event = { 'dmgHeal', -.5 }, --[[ 1 ]]                      text = "THEY SET AN ULTIMATUM_",                     desc = "-0.5 Heal",         duration = 10 },
        { time = 280, event = { 'dmgHeal', -.5 }, --[[ .5 ]]                     text = "YOU CAN'T BE BOTHERED ANYMORE_",             desc = "-0.5 Heal",         duration = 10 },
        { time = 300, event = { 'dmgWrong', 2, 'animDuration', 1 },              text = "ONE LAST PAINFUL ARGUMENT_",                 desc = "+2 FaultDmg   +100% Slowness",           duration = 10 },
        { time = 320, event = { 'reviveDifficulty', 9999 },                      text = "GOODBYE.",                                   desc = "NO NEW REVIVES",      duration = 10, color = 'R' },
        { time = 360, event = { 'dmgHeal', 1, 'animDuration', 1 }, --[[ 1.5 ]]   text = "\"I MISS YOU\"",                             desc = "+1 Heal   +100% Slowness",        duration = 10, color = 'lO' },
        { time = 380, event = { 'dmgHeal', 1 }, --[[ 2.5 ]]                      text = "MAYBE IT CAN STILL WORK_?",                  desc = "+1 Heal",          duration = 10, color = 'lO' },
        { time = 400, event = { 'dmgTimerMul', -.1, 'animDuration', 4 },         text = "GOODBYE.",                                   desc = "[Final]   -10% Timer...   +400% Slowness", duration = 2, final = true },
        { time = 402, event = { 'dmgTimerMul', -.1 },                            text = "",                                           desc = "...-10% Timer...", duration = 2 },
        { time = 405, event = { 'dmgTimerMul', -.1 },                            text = "",                                           desc = "...-10% Timer...", duration = 2  },
        { time = 408, event = { 'dmgTimerMul', -.05 },                           text = "",                                           desc = "...-5% Timer...", duration = 2  },
        { time = 412, event = { 'dmgTimerMul', -.05 },                           text = "",                                           desc = "...-5% Timer...", duration = 2  },
        { time = 416, event = { 'dmgTimerMul', -.05 },                           text = "",                                           desc = "...-5% Timer...", duration = 2  },
        { time = 420, event = { 'dmgTimerMul', -.03 },                           text = "",                                           desc = "...-3% Timer...", duration = 2  },
        { time = 425, event = { 'dmgTimerMul', -.02 },                           text = "",                                           desc = "...-2% Timer!", duration = 2  },
